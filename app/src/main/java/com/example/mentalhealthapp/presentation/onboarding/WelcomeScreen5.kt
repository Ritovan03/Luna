...
@Composable
fun WelcomeScreen5(navController: NavHostController){
    Box(
        modifier = Modifier
            .fillMaxSize()
...
//                )
                ...
                Text(
                    text = buildAnnotatedString {
                        ...
                        withStyle(style = SpanStyle(color = Color(0xFF57341C), fontWeight = FontWeight.Bold)) {
                            append(", One Step at a Time")
                        }
                    },
                    //Build Sensory Resilience, One Step at a Time
                    fontSize = 26.sp,
                ...
                Box(
                    ...
                    Box(
                        modifier = Modifier
                            .fillMaxWidth(0.833f) // 5/6 progress
                            .height(4.dp)
                ...
                // Navigation Button
                Button(
                    onClick = { navController.navigate(Route.Welcome6.route)
